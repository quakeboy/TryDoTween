...
namespace UnityEngine.UI.Extensions
{
	...
	public class DropDownList : MonoBehaviour
	{
		...
		*/
		...
		{
			_overlayRT.transform.localScale = new Vector3(1, 1, 1);  //added by Jeff
			_scrollPanelRT.transform.localScale = new Vector3(1, 1, 1);  //added by Jeff 
			...
			{
				 //scrollOffset = Mathf.RoundToInt(_itemsPanelRT.anchoredPosition.y / _rectTransform.sizeDelta.y); 
			}
		}
	}
}
